...
export const mainStyles = `
  ...
  * {
  ...
  .globe-button:hover:not(:disabled) {
  ...
  .network-dot {
    ...
    border: 1.5px solid var(--xc-connect-button-background);
  }
  ...
  .network-dropdown-item:hover {
    background: var(--xc-background-secondary);
  }
  ...
  .network-dropdown-item .network-name {
    flex: 1;
  }
