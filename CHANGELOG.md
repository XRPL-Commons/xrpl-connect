...
- UI/Vue: cancel stale modal, QR, WalletConnect pre-initialization, manager replacement, account enumeration, and KeepAlive work while preserving focus and document scroll state.
- Documentation: correct public imports, event guidance, adapter capability tables, and browser-safe initialization examples.
